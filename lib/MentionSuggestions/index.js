...
var MentionSuggestions = exports.MentionSuggestions = function (_Component) {
  ...
  function MentionSuggestions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MentionSuggestions.__proto__ || Object.getPrototypeOf(MentionSuggestions)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.closeDropdown();
      var newEditorState = (0, _addMention2.default)(_this.props.store.getEditorState(), mention, _this.props.mentionPrefix, _this.props.mentionSuffix, _this.props.mentionTrigger, _this.props.entityMutability);
  ...
  _createClass(MentionSuggestions, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          mentionSuffix = _props.mentionSuffix,
          elementProps = _objectWithoutProperties(_props, ['entryComponent', 'popoverComponent', 'onClose', 'onOpen', 'onAddMention', 'onSearchChange', 'suggestions', 'ariaProps', 'callbacks', 'theme', 'store', 'entityMutability', 'positionSuggestions', 'mentionTrigger', 'mentionPrefix', 'mentionSuffix']);
