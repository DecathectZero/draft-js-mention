...
var addMention = function addMention(editorState, mention, mentionPrefix, mentionSuffix, mentionTrigger, entityMutability) {
  ...
  var mentionReplacedContent = _draftJs.Modifier.replaceText(editorState.getCurrentContent(), mentionTextSelection, '' + mentionPrefix + mention.name + mentionSuffix, null, // no inline style needed
  entityKey);
